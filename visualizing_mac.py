...
def main(cfg: DictConfig):
    ...
    queries_store = []
    import_folder = str(kg_config.neo4j.import_folder)
    ...
    for file_item in files_list:
        ...
        data_dir = os.path.join(str(kg_config.input), str(file_item["path"]))
            ...
            for file in file_item["files"]:
                ...
                queries_store.append(
                    [
                        ...
                        f"file:///{import_folder}/{file_item['path']}/{file_name}",
                        f"Importing {file_item['name']} data from {file_name}",
                    ]
                )
        else:
            logger.info(
